...
@section('title', 'Input Catatan Wali Kelas | E-Rapor')

@section('content')

<!-- JUDUL DI TENGAH (LUAR KOTAK) - DISAMAKAN UKURANNYA -->
<div class="text-center mb-6 mt-4">
    <h6 class="font-bold text-lg text-gray-800 uppercase tracking-wide">
        Input Catatan Wali Kelas Siswa
    </h6>
</div>
...
<div class="bg-white p-8 rounded-t-3xl shadow-sm border border-gray-100 mt-6 min-h-[calc(100vh-180px)] flex flex-col">
    ...
    <!-- FORM FILTER - DISAMAKAN STRUKTUR FLEX & UKURANNYA -->
    ...
    <!-- TABEL DATA SISWA - DISAMAKAN STYLE & GARISNYA -->
        ...
        <table class="w-full text-sm text-left border-collapse">
            <thead class="bg-gray-50 text-gray-700 font-bold border-b text-xs uppercase">
                <tr>
                    ...
                    <th class="px-4 py-3 border-r text-center w-32">Nilai</th>
                    <th class="px-4 py-3 border-r text-center w-32">Predikat</th>
            ...
            <tbody class="divide-y text-gray-600">
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 border-r uppercase">Contoh Nama Siswa</td>
                    <td class="px-4 py-3 border-r text-center">0012345678</td>
