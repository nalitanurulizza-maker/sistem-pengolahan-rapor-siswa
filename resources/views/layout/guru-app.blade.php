...
<div class="flex">
    ...
    <!-- SIDEBAR (Ukuran & Warna Sama dengan Admin) -->
    <aside class="w-[250px] min-h-screen fixed text-white flex flex-col shadow-xl"
        ...
        <nav class="mt-4 flex-1">
            ...
            <a href="#" class="block py-3 px-5 hover:bg-white/10 transition">
            ...
            <div x-data="{open:false}">
                ...
                <div x-show="open" x-cloak class="text-sm pl-10">
                    <a href="#" class="block py-2 hover:text-cyan-300 transition">+ Input Nilai Rapor</a>
                </div>
            </div>
            ...
            <div x-data="{open:false}">
                ...
                <div x-show="open" x-cloak class="text-sm pl-10">
                    <a href="#" class="block py-2 hover:text-cyan-300 transition">→ Cek Nilai Rapor</a>
                </div>
            </div>
    ...
    <!-- MAIN CONTENT (Margin 250px Sama dengan Admin) -->
