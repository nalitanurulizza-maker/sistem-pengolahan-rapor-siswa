...
<div class="flex">
    ...
    <aside class="w-[210px] min-h-screen fixed text-white flex flex-col shadow-xl bg-gradient-to-b from-[#0d2856] to-[#1e6fdc]">
        ...
        <nav class="mt-4 flex-1">
            ...
            <div x-data="{ open: {{ request()->routeIs('guru.input-nilai') ? 'true' : 'false' }} }">
                <button type="button" @click="open = !open"
                    class="w-full text-left py-3 px-4 flex justify-between items-center hover:bg-white/10 transition text-sm">
                    <span>
                        <i class="fa-solid fa-book-open w-5"></i> Input Nilai
                    </span>
            ...
            <div x-data="{ open: {{ request()->routeIs('guru.cek-nilai') ? 'true' : 'false' }} }">
                <button type="button" @click="open = !open"
                    class="w-full text-left py-3 px-4 flex justify-between items-center hover:bg-white/10 transition text-sm">
                    <span>
                        <i class="fa-solid fa-folder-open w-5"></i> Nilai Tersimpan
                    </span>
                    <i class="fa-solid fa-chevron-down text-[10px] transition-transform duration-300"
                       :class="open ? 'rotate-180' : ''"></i>
                </button>
